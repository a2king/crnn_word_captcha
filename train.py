...
parser.add_argument('-train', '--trainroot', required=True, help='path to train dataset', default="data/output/path")
parser.add_argument('-val', '--valroot', required=True, help='path to val dataset', default="data/output/path")
...
if __name__ == "__main__":
    for epoch in range(params.nepoch):
        ...
        while i < len(train_loader):
            ...
            # 修改为每循环训练params.saveInterval次后保存模型
            if epoch != 0 and epoch % params.saveInterval == 0 and i == 1:
