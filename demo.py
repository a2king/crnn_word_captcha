...
def pred_image(image_path):
    ...
    print("predict image size:{}".format(image.size))
    # 判断图片是大图还是小图
    if image.size == (344, 384):
        image = image.crop(box=(0, 344, 116, 384))
...
if __name__ == '__main__':
    ...
    if model_path and image_path:
        ...
        pred_image(image_path)
    else:
        print("Please fill in the correct model and picture address!")
